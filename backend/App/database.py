...
Robotics Engineer,Senior,"Problem Solving, Communication, Teamwork, Adaptability, Creativity, Work Ethic, Efficiency, Robotics, Machine Learning, AI, Python, C++, ROS, TensorFlow",5,AI Specialist
